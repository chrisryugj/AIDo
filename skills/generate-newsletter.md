...
## STEP 2: 뉴스 검색 (웹 검색 필수)

**반드시 실제 웹 검색을 수행하여 실존하는 최신 뉴스를 찾아야 한다.**
...
- **한글 뉴스만** (영문 기사 제외)
- 제목은 **실제 뉴스 헤드라인** (최소 10자)
- URL은 **실제 접속 가능한 링크** (PDF/HWP/문서 파일 URL 제외)
- 요약은 **1-2문장, 최대 2줄** (최소 20자)
